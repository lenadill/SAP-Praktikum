(function() {
    function init() {
        console.log("Transactions JS init");
        ...
        if (!modal || !btnAdd) {
            console.log("Kritische Elemente nicht gefunden!", {modal, btnAdd});
            return;
        }
        ...
        function renderTable(entries) {
            if (!entries || entries.length === 0) {
                tableBody.innerHTML = '<tr><td colspan="4" class="empty">No entries found</td></tr>';
                return;
            }
